...
const productos = [
  ...
  { id:3,  nombre:'Auriculares ANC Pro',     marca:'Sony',     cat:'Audio',          desc:'Cancelación activa de ruido híbrida, 40h batería, codec LDAC Hi-Res.',          precio:149990,  icono:'🎧', stock:16, off:20,   rating:4.7, reviews:203,
    specs:[['Driver','40mm dinámico'],['Respuesta frec.','4Hz-40kHz'],['ANC','Híbrido 8 micrófonos'],['Batería','40h (ANC on)'],['Carga','USB-C, 10min=5h'],['Codec','LDAC, AAC, SBC'],['Peso','254g'],['Conexión','Bluetooth 5.2']] },
  ...
  { id:8,  nombre:'Hub USB-C 12en1',        marca:'Anker',    cat:'Accesorios',     desc:'HDMI 4K@60Hz x2, SD/microSD, Ethernet 1Gbps, PD 100W, USB 3.2.',               precio:49990,   icono:'🔌', stock:47, off:5,    rating:4.6, reviews:189,
    specs:[['Puertos','12 en total'],['HDMI','2x 4K@60Hz'],['USB-A','3x USB 3.2 Gen2'],['USB-C','2x (datos + PD)'],['PD','100W pass-through'],['Ethernet','1Gbps'],['SD/microSD','UHS-II'],['Peso','120g']] },
  { id:9,  nombre:'Mouse Gaming Pro',       marca:'Logitech', cat:'Periféricos',    desc:'25600 DPI, 8 botones programables, RGB, sensor óptico Hero 25K.',               precio:59990,   icono:'🖱️', stock:22, off:null,  rating:4.7, reviews:143,
    specs:[['Sensor','Hero 25K'],['DPI','100-25600'],['Botones','8 programables'],['Polling rate','1000Hz'],['Cable','1.8m trenzado'],['Peso','101g'],['RGB','Logo + scroll'],['Conexión','USB-A']] },
  ...
  { id:12, nombre:'Laptop Ultrabook 14"',   marca:'LG',       cat:'Laptops',        desc:'Intel Core Ultra 7, 16GB LPDDR5, 1TB SSD, batería 18h, 1.2kg.',                 precio:899990,  icono:'💻', stock:13, off:8,    rating:4.7, reviews:91,
    specs:[['CPU','Intel Core Ultra 7 155H'],['RAM','16GB LPDDR5'],['Almac.','1TB NVMe SSD'],['Pantalla','14" OLED 2.8K 120Hz'],['Batería','18h'],['Peso','1.2kg'],['SO','Windows 11 Home'],['Puertos','2x TB4, HDMI']] },
  ...
  { id:16, nombre:'Pad Mouse XL RGB',       marca:'Razer',    cat:'Accesorios',     desc:'900x400mm, superficie de tela premium, base antideslizante, RGB 14 zonas.',     precio:29990,   icono:'🟦', stock:62, off:null,  rating:4.3, reviews:234,
    specs:[['Dimensiones','900x400x3mm'],['Material','Micro-textura tela'],['Base','Goma antideslizante'],['RGB','14 zonas Chroma'],['Cable','USB-A 1.8m'],['Velocidad','Optimizado todos DPI'],['Peso','390g'],['Lavable','No']] },
]
      ...
      <div className="detalle-body">
        ...
        <div className="detalle-info">
          ...
          <div className="detalle-acciones">
            ...
            <button
              className={`btn-agregar ${agregado ? 'btn-agregado' : ''}`}
              ...
              {[5,4,3].map(r => (
                <div key={r} className="review-item">
                  ...
                  <div className="review-txt">
                    Excelente producto, cumple con todo lo prometido. La calidad es muy buena para el precio.
                  </div>
                </div>
              ))}
            </div>
